...
# MAGIC <img width="1px" src="https://www.google-analytics.com/collect?v=1&gtm=GTM-NKQ8TT7&tid=UA-163989034-1&aip=1&t=event&ec=dbdemos&ea=VIEW&dp=%2F_dbdemos%2Fdata-science%2Fllm-dolly-chatbot%2F01-Dolly-Introduction&cid=1444828305810485&uid=4656226177354106">

# COMMAND ----------

# MAGIC %md-sandbox
# MAGIC ## Building a quant ChatBot to answer our questions
# MAGIC
# MAGIC In this demo, we'll be building a Chat Bot to based on Dolly. 
# MAGIC
...
# MAGIC
# MAGIC ```
# MAGIC IA: I'm a quant bot, how can I help ?
